...
const Timeline = () => {
  ...
  >
    ...
    {experiences.map((exp, index) => (
      ...
      >
        <div
          className={`w-4/5 lg:w-1/2 px-4 text-gray-400  mb-0 lg:mb-14 text-sm opacity-0 ${
        ...
        <div
          className={`w-16 h-16 bg-pink-500 mb-4 sm:mb-16 text-white rounded-full flex items-center justify-center border-4 ml-6 mr-6 border-white z-10 opacity-0 ${
        ...
        <div
          ...
          } ${index % 2 === 0 ? " text-center lg:text-left ml-0 lg:ml-8" : " text-center lg:text-right mr-0 lg:mr-8"} hover:bg-gray-200 hover:scale-105 transform transition-all duration-300 ease-in-out`}
          style={{
